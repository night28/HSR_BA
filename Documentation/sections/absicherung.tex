...
Wichtig ist insbesondere, dass die beiden Nodes über dieselbe Zeit verfügen und miteinander kommuniziern können.
...
Sofern der Primary Node noch im Standalone Modus ist, kann dieser zum Primary Node gewählt werden. Ist diser bereits in der Rolle Primary Node ist der nächste Schritt nicht nötig.
...
In der Lab Umgebung wurde die Auswahl auf den Policy Service und SXP beschränkt, da dies die Dienste sind, die wir zwingend benötigen. 
