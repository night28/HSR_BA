...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{img/Absicherung/ISE-SizeScalingRec}
	\caption{ISE - Size and Scaling Recommendation}
	\label{fig:ISE - Size and Scaling Recommendation}
\end{figure}

Die folgende Tabelle enthält eine Empfehlung für den Gerätetyp, welcher für einen dedizierten Policy Service Node benötigt wird. Dies ist basierend auf der maximalen Anzahl aktiver Sessions zu den Node Services.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{img/Absicherung/ISE-PolicyServiceNodeSizeRec}
	\caption{ISE - Policy Service Node Size Recommendations}
	\label{fig:ISE - Policy Service Node Size Recommendations}
\end{figure}

Die folgende Tabelle gibt einen Überblick über den Gerätetyp, der für einen dedizierten pxGrid-Node benötigt wird, basierend auf der Anzahl der maximal aktiven Sessions, die der Knoten bedient.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{img/Absicherung/ISE-pxGridSizingRec}
	\caption{ISE - pxGrid Node Sizing Recommendations}
	\label{fig:ISE - pxGrid Node Sizing Recommendations}
\end{figure}
