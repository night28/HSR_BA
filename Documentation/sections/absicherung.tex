...
Dieser Ablauf funktioniert folgendermassen: Nachdem ein Peer eine SXP-Verbindung beendet hat, startet ein interner Holddown-Timer. Wenn sich der Peer erneut verbindet, bevor der interne Holddown-Timer abläuft, wird der Timer für die SXP-Abgleichperiode gestartet. Während der Timer für den SXP-Abgleichzeitraum aktiv ist, wird die von der vorherigen Verbindung gelernten SGT-Zuordnungseinträge beibehalten und ungültige Einträge entfernt. Der Standardwert ist 120 Sekunden (2 Minuten). Wenn Sie den SXP-Abstimmungszeitraum auf 0 Sekunden setzen, wird der Timer deaktiviert und alle Einträge der vorherigen Verbindung werden entfernt.
