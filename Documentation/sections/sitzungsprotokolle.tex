...
\begin{itemize}	
	...
	\item ENCS 5000: NTP, DHCP Backup, Subinterfaces
	\item Zwischenpräsentation: Design Ansätze und Aktueller Stand
...
\begin{itemize}	
	...
	\item BA Endtermin formell ausstehend, aber wahrscheinlich bis Mitte Januar verlängert	
...
\begin{itemize}	
	...
	\begin{itemize}
		\item Vorschlag: Config-History mit diffs
	\end{itemize}
\end{itemize}
...
\begin{itemize}	
	...
	\item Use Cases für Teil 3
	\begin{itemize}
		\item Archdrive für Config-History mit diffs (Zeitstempel, Passwörter und weiteres überschreiben)
	\end{itemize}
...
\subsection{Sitzungsprotokoll 26.11.2018}
...
\begin{itemize}	
	...
	\item Feedback Analyse
	\item Feedback Absicherung
	\item Vorbesprechung Zwischenpräsentation 
\end{itemize}

\paragraph{Beschlüsse (Diskussion)}
\begin{itemize}	
	\item Bewertung der Studienarbeit wurde mündlich besprochen
	\item Zwischenpräsentation
	\begin{itemize}
		\item Kurze Einführung
		\item Architektur gemäss Maximum Scale Recommendations
		\item Analyse und Absicherung in einem mit kritischen Komponenten
		\item ENCS kurzer Stand
		\item Ausblick mit weiteren Schritten - Use Cases direkt nach Zwischenpräsentation besprechen
	\end{itemize}	
\end{itemize}
